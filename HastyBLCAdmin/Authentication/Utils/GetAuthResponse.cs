...
namespace HastyBLCAdmin.Utilities
{
    public class GetAuthResponse
    {
        ...
        /// <returns></returns>
        public static LoginViewModel Execute(ClaimsIdentity identity, HastyDBContext db, IdentityUser userName, RefreshToken refreshToken = null)
        {
