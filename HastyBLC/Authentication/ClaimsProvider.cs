...
namespace HastyBLC.Authentication
{
    public class ClaimsProvider
    {
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        public async Task<ClaimsIdentity> GetClaimsIdentityAsync(string username, string password, HastyDBContext db)
        {
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        public async Task<ClaimsIdentity> GetIdentityAsync(string username, HastyDBContext db)
        {
            ClaimsIdentity claimsIdentity = null;
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        public ClaimsIdentity CreateClaimsIdentity(IdentityUser user, HastyDBContext db)
        {
